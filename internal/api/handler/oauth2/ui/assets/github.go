...
func SVGGitHub(width, height int) gomponents.Node {
	return gomponents.Rawf(dedent.Dedent(`
		<svg xmlns="http://www.w3.org/2000/svg" width="%d" height="%d" viewBox="0 0 98 96">
			<defs>
				<style>
					path {
						color: #666;
			...
			<style id="stylus-1" type="text/css" class="stylus">._wrapper_6hqet_97 {
